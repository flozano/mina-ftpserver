 ...
 *
 * Extends RetrieveTest to inherit all 8 file retrieval tests and runs them in passive mode
 * with multiplexing explicitly disabled.
 */
public class RetrieveMultiplexDisabledTest extends RetrieveTest {
